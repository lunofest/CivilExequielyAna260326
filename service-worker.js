const CACHE_NAME = 'cache-v48'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v48',
    'estilos/styles.css?v48',
    'estilos/mediaQueries.css?v48',
    'javascript/script.js?v48',
